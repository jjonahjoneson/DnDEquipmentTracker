/*
    ...
    */
    ...
    class InventoryTracker{
        ...
        static TEMPLATES = {
            INVENTORYTRACKER: `modules/${this.ID}/templates/jit.hbs`
        }
    ...
    */
        ...
        */
        ...
        static loadUserEquipment(userID){
            try{
                ...
                document.getElementById("head").title = userEquipment.headDesc;
                ...
                document.getElementById("body").title = userEquipment.bodyDesc;
                ...
                document.getElementById("hands").title = userEquipment.handsDesc;
                ...
                document.getElementById("boots").title = userEquipment.bootsDesc;
                ...
                document.getElementById("acc1").title = userEquipment.acc1Desc;
                ...
                document.getElementById("acc2").title = userEquipment.acc2Desc;
                ...
                document.getElementById("acc3").title = userEquipment.acc3Desc;
                ...
                document.getElementById("acc4").title = userEquipment.acc4Desc;
    ...
    Hooks.on('renderPlayerList', (playerList, html) => {
        ...
        const tooltip = game.i18n.localize('jit.button-title');
